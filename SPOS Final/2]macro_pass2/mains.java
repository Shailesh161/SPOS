...
class mains
{
	...
	public static void main(String[] args) throws IOException 
	{
		...
		int macro_addr = -1;
	 	...
	 	BufferedReader b_read=new BufferedReader(new FileReader("MNT.txt"));
	 	String line;
		...
		b_read=new BufferedReader(new FileReader("ARG.txt"));
		...
		b_read=new BufferedReader(new FileReader("MDT.txt"));
	 	while((line = b_read.readLine())!=null)
	 	{
	 		MDT[mdt_cnt]=new mdt();
		...
		b_read=new BufferedReader(new FileReader("input.txt"));
